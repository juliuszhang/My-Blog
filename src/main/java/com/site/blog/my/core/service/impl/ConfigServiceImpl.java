...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String yourEmail = "juliuszhang@outlook.com";
    public static final String yourName = "yibozhang";

    public static final String footerAbout = "your personal blog. have fun.";
    public static final String footerICP = "";
    public static final String footerCopyRight = "@2019 yibozhang";
